...
import Loglude.Editor.Actions (createBranch, createNode, deleteBranch, deleteConnection, deleteNode, dropPattern, editBranch, evaluateQuery, rememberMousePosition, selectNestedNode, selectNode, selectPin, updateHovered, usesPointerEvents)
...
scene initial =
    ...
    handleAction = case _ of
        ...
        ForeignAction (EvaluateQuery cst) -> evaluateQuery cst >>= (initial.emitQueryResult >>> liftEffect)
